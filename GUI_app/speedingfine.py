...
class SpeedingFineCalculator: # Business Tier
    minimumFine = 50
    penaltyPerMPH = 5
    ...
    def calculateSpeedingFine(self, clockedSpeed):
        ...
        if clockedSpeed <= self.__speedingLimit:
            ...
            speedOverLimit = clockedSpeed - self.__speedingLimit
            fine = SpeedingFineCalculator.minimumFine + (speedOverLimit * SpeedingFineCalculator.penaltyPerMPH)
            if speedOverLimit >= 50:
